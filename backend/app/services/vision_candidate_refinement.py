        ...
        messages=[
            {
                "role": "system",
                "content": (
                    "You rerank short-form drama clip candidates for a Korean commentary channel. "
                    "Use the frames and subtitle excerpt together. "
                    "Return strict JSON with keys: "
                    "score_delta (-1.5..1.5), visual_hook_score (0..10), self_contained_score (0..10), "
                    "emotion_shift_score (0..10), thumbnail_strength_score (0..10), "
                    "vision_reason (short Korean sentence, max 140 chars), "
                    "title_hint (string or null, max 90 chars), note (string or null, max 220 chars). "
                    "Prioritize scenes that are funny/comedic, ironic, witty, heartwarming, moving, or emotionally resonant. "
                    "Reward clips that can be understood without much setup and have a visually strong hook. "
                    "If the frames are weak or the excerpt is empty, keep score_delta near 0 or negative."
                ),
            },
            {
                "role": "user",
